...
public class Converter {
    ...
    public static RD fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(RD obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(RD.class);
        writer = mapper.writerFor(RD.class);
    }
