...
public class StructuralVariant {
    ...
    private List<StructuralVariantAcmgCriterion> acmgCriteria;
    private String cDnaChange;
    private List<StructuralVariantExternalId> externalIds;
    private String gDnaChange;
    private List<Coding> genes;
    private String id;
    private String iscnDescription;
    ...
    public List<StructuralVariantAcmgCriterion> getAcmgCriteria() { return acmgCriteria; }
    @JsonProperty("acmgCriteria")
    public void setAcmgCriteria(List<StructuralVariantAcmgCriterion> value) { this.acmgCriteria = value; }
    ...
    public List<StructuralVariantExternalId> getExternalIds() { return externalIds; }
    @JsonProperty("externalIds")
    public void setExternalIds(List<StructuralVariantExternalId> value) { this.externalIds = value; }
    ...
    @JsonProperty("iscnDescription")
    public String getIscnDescription() { return iscnDescription; }
    @JsonProperty("iscnDescription")
    public void setIscnDescription(String value) { this.iscnDescription = value; }
